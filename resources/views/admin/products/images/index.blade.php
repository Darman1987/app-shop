...
<div class="main main-raised">
    <div class="container">
        ...
        <div class="section text-center">
            ...
            <form method="post" action="" enctype="multipart/form-data"> <!-- enctype="multipart/form-data" atributo requerido para poder subir imagenes-->
                {{csrf_field()}}  <!-- token para verificar  que la peticion sea legitima-->
                <input type="file" name="photo" required>
                <button  class="btn btn-primary btn-round">Subir nueva imagen</button>                
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                 <div class="panel-body">
                    <img src="{{$image->url}}" width="250"><!--se hace uso del accesor definido en el modelo productImage-->
